      ...
      <main className="max-w-6xl mx-auto w-full px-4 py-12">
        ...
        <div className="flex flex-col gap-4 mb-10 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            <div className="relative flex-1 md:flex-initial md:w-full">
              ...
              <input
                type="text"
                className="w-full pl-12 pr-4 py-4 bg-[#181b20] border border-[#23272f] rounded-xl text-text text-lg placeholder-text-muted/60 focus:outline-none focus:ring-2 focus:ring-accent shadow-lg"
            ...
            <select
              className="w-full md:w-56 px-4 py-4 bg-[#181b20] border border-[#23272f] rounded-xl text-text text-lg focus:outline-none focus:ring-2 focus:ring-accent shadow-lg"
              value={selectedState}
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              {selectedState && (
                <div className="bg-blue-500/10 text-blue-400 text-sm px-3 py-1.5 rounded-full flex items-center gap-2">
                  <span>State: {stateNames[selectedState] || selectedState}</span>
        ...
        <div className="flex flex-col gap-6">
          {filtered.map(game => {
            ...
            // Get latest result data if available
